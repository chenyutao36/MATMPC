...
/* h_fun:(states[36],controls[6],params[0])->(h[30]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem) {
  ...
  a0=-1.8702006980802791e-01;
  a2=arg[0] ? arg[0][6] : 0;
  a2=(a0*a2);
  a1=-2.1815008726003490e-03;
  a3=arg[0] ? arg[0][7] : 0;
  a3=(a1*a3);
  a2=(a2+a3);
  a3=arg[0] ? arg[0][27] : 0;
  ...
  a2=arg[0] ? arg[0][8] : 0;
  a2=(a0*a2);
  casadi_real a4=arg[0] ? arg[0][9] : 0;
  a4=(a1*a4);
  a2=(a2+a4);
  a4=arg[0] ? arg[0][25] : 0;
  a2=(a2+a4);
...
void mex_h_fun(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+36, casadi_s1, w+72);
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+42, casadi_s2, w+72);
  casadi_real* res[1] = {0};
  --resc;
  res[0] = w+42;
  i = h_fun(arg, res, iw, w+72, 0);
