...
/* path_con_fun:(states[36],controls[6],params[0])->(path_con[6]) */
...
void mex_path_con_fun(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+48);
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+36, casadi_s1, w+48);
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+42, casadi_s2, w+48);
  casadi_real* res[1] = {0};
  --resc;
  res[0] = w+42;
  i = path_con_fun(arg, res, iw, w+48, 0);
