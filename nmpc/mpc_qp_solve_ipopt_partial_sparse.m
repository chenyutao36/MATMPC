...
%     [x,fval,exitflag,output,lambda] = quadprog(H,mem2.ipopt_data.g, [mem2.ipopt_data.dBg;-mem2.ipopt_data.dBg],...
%                                                [mem2.uc;-mem2.lc], mem2.ipopt_data.dG, mem2.ipopt_data.G,...
%                                                ipopt.options.lb, ipopt.options.ub, zeros(nw,1));
